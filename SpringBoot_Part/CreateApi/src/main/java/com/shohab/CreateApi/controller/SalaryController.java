...
//    }
    ...
    public ResponseEntity<com.shohab.CreateApi.model.Salary> saveEmpSalary(@RequestBody com.shohab.CreateApi.model.Salary salary) {
        String employeeName = salary.getEmployee().getName();
        com.shohab.CreateApi.model.Employee employee = employeeRepository.findByName(employeeName).get();
